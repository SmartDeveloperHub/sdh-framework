...
(function() {
    ...
    /* CytoChart_old constructor
     *   element: the DOM element that will contain the CytoChart_old
     ...
     *      }
     */
    var CytoChart_old = function CytoChart_old(element, metrics, contextId, configuration) {

        if(!framework.isReady()) {
            console.error("CytoChart_old object could not be created because framework is not loaded.");
            return;
        }

        // CHECK cytoscape
        if(typeof cytoscape === 'undefined') {
            console.error("CytoChart_old could not be loaded.");
            return;
        }
        ...
        this.element.addClass('CytoChart_old');
        this.data = null;
        this.chart = null;
        this.labels = {};
    ...
    CytoChart_old.prototype = new framework.widgets.CommonWidget(true);

    CytoChart_old.prototype.updateData = function(framework_data) {
    ...
    CytoChart_old.prototype.delete = function() {
    ...
    window.framework.widgets.CytoChart_old = CytoChart_old;

    // AMD compliant
    if ( typeof define === "function" && define.amd) {
        define( ['jquery-qtip', 'cytoscape', 'cytoscape-qtip'], function () { return CytoChart_old; } );
    }
